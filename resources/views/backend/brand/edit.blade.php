        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="radio_status_edit_brand_active" name="status" class="custom-control-input" value="1">
              <label class="custom-control-label" for="radio_status_edit_brand_active">Active</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="radio_status_edit_brand_unactive" name="status" class="custom-control-input" value="0">
