...
<div class="row mb-4">
  <div class="col-lg-4 col-6 mr-auto">
    <a href="{{ route('products.create') }}" class="btn btn-success btn-block"><i class="fa fa-plus-circle fa-fw"></i>
      Create Product</a>
  </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="col" width="1%">
              <button id="bulk_delete" data-toggle="modal" data-target="#modal_delete_product" type="submit"
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              if($product->status) {  
            ?>
              <a href="{{ url('/unactive-product/'.$product->id) }}"><span class='badge badge-success'>ON</span></a>
              <?php
              } else {
            ?>
              <a href="{{ url('/active-product/'.$product->id) }}"><span class='badge badge-secondary'>OFF</span></a>
              <?php
              }               
            ?>
            </td>
